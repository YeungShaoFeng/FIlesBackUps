    ...
    def getJSON(self, url):
        if self.me:
            ...
            try:
                ...
                rheaders = FetcherX.loadJson(self, data=r.headers)
                FetcherX.saveJson(self, rheaders, "./GitogramHeaders.json")
                # --
        return self.GitogramJson
...
fetcherx.getJSON(
    "https://app.fetcherx.com/api/data/rss?url=rss-f0e5191f3f55322da1ec57759a056fc0"
)
