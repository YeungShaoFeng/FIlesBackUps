...
public:
	...
	void getinputs(int mode);
    void smallIn(int inMode, int printMode);
    void smallOut(int outMode, int printMode);
    void toSingle();

    //testing functions
	enum Modes{e, d, ef, df, ed, dd}Modes;
    void setString(int which, string text);
    void printString(void);
private:
	// char *plaintext, *password, *fileroute, *dirrout;
	string plaintext, password, fileroute, dirrout;
};
