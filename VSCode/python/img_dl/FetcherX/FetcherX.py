...
class FetcherX:
    def __init__(self, startUrl, Range):
        ...
        self.headers = {
            ...
            "Referer": "https://app.fetcherx.com/folder/5c5d5d4a3c187b00090b5579",
...
fetcherx = FetcherX("", 1)
url = "https://app.fetcherx.com/api/post/isSaved?url=https%3A%2F%2Fpbs.twimg.com%2Fmedia%2FEBmuwW8WwAAapfA.jpg"
