...
void printAllAcceleration(int16_t *ax, int16_t *ay, int16_t *az,
                          ...
                          int16_t *gx, int16_t *gy, int16_t *gz)
{
    ...
    Serial.print("a:\t");
    Serial.print(*ax / 16330.0 + 0.025);
    Serial.print("\t"); //
    Serial.print(*ay / 16330.0 + 0.015);
    Serial.print("\t"); //
    Serial.println(*az / 17170.0 - 0.98);
    Serial.print("g:\t");
    Serial.print(*gx / 266.0 - 0.90);
    Serial.print("\t");
    Serial.print(*gy / 800.0 - 0.93);
    Serial.print("\t");
