...
const emitter = new EventEmitter(); // 1315
            ...
            _createHelper: function() {
                ...
                return function(r) {
                    return {
                        ...
                        linxi: emitter.on('linxiWantsToEncrypt', arg=>{
                        console.log(t(arg.I).encrypt(r,arg.E,arg.I,arg.N))
                        })
                        ,
...
// let AAA = {
//     E:"1570098219713" + "\b\xa7",
//     I:"650219"
// };
// emitter.emit('linxiWantsToEncrypt', AAA);